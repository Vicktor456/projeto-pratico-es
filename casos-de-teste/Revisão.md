...
Regra de Negócios: O arquivo gerado para compartilhamento deve manter os mesmos padrões de fonte ampliada e alto contraste definidos para a visualização em tela.
